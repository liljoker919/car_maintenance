...
class VehicleListView(LoginRequiredMixin, ListView):
    """
    Display a list of vehicles owned by the current user.

    Optimized with pagination and related data prefetching.
    """
    ...
    def get_queryset(self):
        ...
        Optimizes query by prefetching related insurance policies,
        registrations, and service records.
        """
...
class VehicleDetailView(LoginRequiredMixin, DetailView):
    """
    Display detailed information for a specific vehicle.

    Shows vehicle details along with related insurance policies,
    registrations, and service records.
    """
    ...
    def get_context_data(self, **kwargs):
        ...
        context["service_records"] = ServiceRecord.objects.filter(vehicle=self.object)
